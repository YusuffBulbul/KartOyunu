...
public class Obus extends Kara {
    ...
    public Obus(int seviyePuani, String altsinif, int denizVurusAvantaji, int dayaniklilik, String sinif, int vurus) {
        super(seviyePuani);
    ...
    @Override
    protected void setDenizVurusAvantaji(int denizVurusAvantaji) {
        this.denizVurusAvantaji = denizVurusAvantaji;
    }
    ...
    protected void DurumGuncelle(String kart, String karsiKart, int hasar, Oyuncu oyuncu, Oyuncu bilgisayar) {
        ...
        if (yeniDayaniklilik == 0) {
            ...
            if (karsiKartIndex >= 0) {
                ...
                System.out.println("Oyuncu kariı: " + karsiKart + " seviyesine " + eklenenSeviye + " eklendi.");
            } else {
